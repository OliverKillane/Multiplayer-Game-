...
#include <memory>
#include "../../MultiplayerGame/CommunicationClient.h"
...
QT_MOC_LITERAL(1, 20, 11), // "RecieveData"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 8), // "GameData"
QT_MOC_LITERAL(4, 42, 4), // "data"
QT_MOC_LITERAL(5, 47, 5), // "Error"
QT_MOC_LITERAL(6, 53, 8), // "SendData"
QT_MOC_LITERAL(7, 62, 18), // "ServerDataRecieved"
QT_MOC_LITERAL(8, 81, 10), // "CatchError"
QT_MOC_LITERAL(9, 92, 28), // "QAbstractSocket::SocketError"
QT_MOC_LITERAL(10, 121, 11) // "socketError"

    },
    "CommunicationClient\0RecieveData\0\0"
    "GameData\0data\0Error\0SendData\0"
    "ServerDataRecieved\0CatchError\0"
...
void CommunicationClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->RecieveData((*reinterpret_cast< GameData(*)>(_a[1]))); break;
        ...
        {
            using _t = void (CommunicationClient::*)(GameData );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CommunicationClient::RecieveData)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (CommunicationClient::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CommunicationClient::Error)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void CommunicationClient::RecieveData(GameData _t1)
{
...
// SIGNAL 1
void CommunicationClient::Error(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
